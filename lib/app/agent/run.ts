...
export const SYSTEM_PROMPT = [
  ...
  "- Worked example: user asks \"Which items in the bid relate to drainage?\" → use search_documents filtered to CSV rows and cite each hit by rowId. For a borderline question like \"drainage items and how much did they cost?\", chain search_documents → query_bids in the same turn so the semantic hits drive the numeric follow-up.",
  "",
  "CITATIONS",
